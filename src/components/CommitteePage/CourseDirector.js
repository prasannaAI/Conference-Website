      ...
      <div className="bg-white text-background ">
          <div className="py-8 flex flex-col container mx-auto px-6 ">
              ...
              <div className="flex flex-wrap justify-center  md:mt-8">
                  ...
                  <div className="p-4 lg:w-1/2  flex justify-start">
                      <div className="h-full flex sm:flex-row flex-col items-center sm:justify-start justify-center text-center sm:text-left">
                          <img alt="team" className="flex-shrink-0 rounded-lg w-48 h-48 object-cover object-center sm:mb-0 mb-4" src="/assets/images/profile.png" />
                          <div className="flex-grow sm:pl-8">
