...
export const AGENDA_DAY_THREE = [
    ...
    },
    {
        ...
        name:  (
            <>
                <div className="font-extrabold  underline mb-4">
                    SRS/SRT of Renal Cancer
                </div>
                <div className="mb-4">
                    &rarr; Moderators: Professor Appu Thomas (Kochi, India); Dr. Maris Mezeckis (Sigulda, Latvia)
                </div>
                <div className="mb-4">
    ...
    },
    {
        ...
        name:  (
            <>
                ...
                <div className="mb-4">
                    &rarr; Speaker: Dr. Maris Mezeckis (Sigulda, Latvia)
                </div>
                <div className="font-extrabold  underline mb-4">
                    Radiosurgery of Prostate Cancer: Complications and their Avoidance
                </div>
                <div className="mb-4">
    ...
    },
    {
        ...
        name: (
            <>
                <div className="font-extrabold  underline mb-4">
                    ISRS, Its Current Activities, and Future Projects
                </div>
                <div className="mb-4">
                    &rarr; Moderators: Professor Rakesh Jalali (Chennai, India); Professor Selcuk Peker (Istanbul, Turkey)
                </div>
                <div className="mb-4">
