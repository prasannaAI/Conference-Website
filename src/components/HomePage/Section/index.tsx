...
const Section = () => {
    ...
    return (
        <div className="relative h-screen">
            ...
            <div className="flex flex-col justify-center items-start z-10 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full max-w-screen-xl mx-auto px-6">
